export const MessagesIcons = ({ className, width = '2.6rem', height = '2.6rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const InboxIcons = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const GPSIcon = ({ width = '1em', height = '1em' }) => (
    <svg
        fontSize="14px"
        viewBox="0 0 48 48"
        fill="currentColor"
        ...
        height={height}
    >
        <path d="M0 5a5 5 0 0 1 5-5h38a5 5 0 0 1 5 5v38a5 5 0 0 1-5 5H5a5 5 0 0 1-5-5V5Z" fill="#13BD90"></path>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const LikeIcon = ({ width = '2.4rem', height = '2.4rem' }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const LikeIconActive = ({ width = '2.4rem', height = '2.4rem' }) => (
...
export const SendToFriendsIcon = (width = '2.6rem', height = '2.6rem') => (
    <svg width={width} data-e2e="" height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const FacebookIcon = (width = '2.6rem', height = '2.6rem') => (
    <svg width={width} data-e2e="" height={height} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
export const WhatsAppIcon = (width = '2.6rem', height = '2.6rem') => (
    <svg width={width} data-e2e="" height={height} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
